          ...
          <?php if ($_SESSION['user'] ?? false) : ?>
            ...
            <div class="relative ml-3">
              ...
              <form method="POST" action="/sessions">
                ...
                <button type="submit" class="<?= urlIs('/logout') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Logout</button>
              </form>
            </div>
          <?php else : ?>
            <div class="relative ml-3">
